...
const team = [
  {
    ...
    image: "/meridian-partners/images/allan-bradford-founding-20partner-compressed.webp",
  },
  {
    name: "Christopher Jordan",
    role: "Partner",
    bio: "Former Goldman Sachs Principal. Deep expertise in industrial growth equity.",
    image: "/meridian-partners/images/christopher-20jordan-partner-compressed.webp",
  },
  {
    name: "Juliette Knowles",
    role: "SVP Investments",
    bio: "Ex-McKinsey Partner. Driven 40%+ margin improvement across portfolio.",
    image: "/meridian-partners/images/juliette-20knowles-svp-20investments-compressed.webp",
  },
]
            ...
            <AnimateOnScroll key={member.name} delay={index * 150}>
              <div className="group cursor-pointer">
                <div className="aspect-[4/5] bg-secondary mb-6 overflow-hidden">
                  <Image
                    src={member.image || "/meridian-partners/placeholder.svg"}
                    alt={member.name}
                    width={400}
                    height={500}
                    unoptimized
