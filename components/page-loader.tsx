...
const ICON_URL = "/meridian-partners/images/crosshaven-icon.svg"
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6">
        <Image
          src={ICON_URL || "/meridian-partners/placeholder.svg"}
          alt="Meridian"
          width={64}
          height={64}
          className="w-16 h-16"
        ...
        <p className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground">Meridian</p>
      </div>
    </div>
  )
}
