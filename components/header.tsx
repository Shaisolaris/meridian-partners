...
const LOGO_URL = "/meridian-partners/images/crosshaven-logo.svg"
    ...
    >
      ...
      <nav className="flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 px-6 lg:px-8 py-5">
          <Image
            src={LOGO_URL || "/meridian-partners/placeholder.svg"}
            alt="Meridian"
            width={180}
            height={58}
        ...
        <div className="hidden md:flex self-stretch min-w-[200px]">
          <Button className="group rounded-none w-full h-full text-[13px] font-medium tracking-wide uppercase justify-center hover:bg-foreground" onClick={() => document.getElementById("contact")?.scrollIntoView({behavior:"smooth"})}>
            Contact Us
            <ArrowUpRight
